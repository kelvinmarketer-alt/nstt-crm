  ...
  window.printReceipt = function(r) {
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><title>Phiếu thu ${r.no}</title>
      <style>
        ...
        .logo{width:152px;height:auto;object-fit:contain;flex:0 0 auto}
        .info{flex:1}
      ...
      <div class="head">
        <img class="logo" src="${(location.origin||'')+'/assets/logo-name.png?v=486'}" alt="Nông Sản Tuấn Tú Hà Nội" onerror="this.style.display='none'">
        <div class="info">
